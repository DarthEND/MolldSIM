...
?>
    <section class="hero">
        <div class="hero-content">
            <div>
                <h1>
                    Toate abonamentele,
                    <span class="hero-highlight">într-un singur loc</span>.
                </h1>
                <p>
                    MolldSIM te ajută să compari rapid abonamente la telefonie mobilă,
            ...
            <div class="how-it-works-grid">
                <div class="step-card">
                    ...
                    <p class="step-description">
                        Alege între Telefonie mobilă, Internet sau Internet + TV.
                        Fiecare secțiune îți arată operatorii disponibili.
                    </p>
                </div>
                <div class="step-card">
                    <div class="step-icon-wrapper">
                    ...
                    <p class="step-description">
                        Vezi prețuri, viteze, minute și beneficii unul lângă altul.
                        Identifică rapid ce se potrivește nevoilor tale.
                    </p>
                </div>
                <div class="step-card">
                    <div class="step-icon-wrapper">
                    ...
                    <p class="step-description">
                        Ai găsit planul ideal? Te ghidăm către furnizor pentru activarea
                        abonamentului tău.
                    </p>
                </div>
            </div>
    ...
    <section id="planuri" class="how-it-works">
        <div class="container">
            <div class="section-header">
                <p class="kicker">Serviciile noastre</p>
                <h2 class="section-title">Alege categoria</h2>
                <p class="section-subtitle">
                    Explorează toate opțiunile disponibile pentru telefonie, internet și TV.
                </p>
            </div>
            <div class="how-it-works-grid">
                <div class="step-card">
            ...
            <div class="how-it-works-grid" style="margin-top: 2rem;">
                <div class="step-card">
                    <h3 class="step-title">Internet + TV</h3>
                    <p class="step-description">
        ...
        <div class="faq-list">
            <details class="faq-item">
                <summary class="faq-question">
                    Cum funcționează MolldSIM?
                    <span class="faq-toggle">+</span>
                </summary>
                <div class="faq-answer">
                    Navighezi pe secțiuni (Mobil, Internet, Internet + TV), alegi
                    operatorul din tab-uri și compari planurile.
                </div>
            </details>
            <details class="faq-item">
                <summary class="faq-question">
                ...
                <div class="faq-answer">
                    Sunt orientative. Pot varia în funcție de promoții, echipamente
                    sau adresă.
                </div>
            </details>
            <details class="faq-item">
                <summary class="faq-question">
                    Pot activa direct un abonament?
                    <span class="faq-toggle">+</span>
                </summary>
                <div class="faq-answer">
                    Îți arătăm opțiunile și te ghidăm către furnizorul ales pentru
                    activare.
                </div>
            </details>
        </div>
